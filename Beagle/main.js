...
function FastClick(a, b) {
  "use strict";
  var c;
  if (b = b || {}, this.trackingClick = !1, this.trackingClickStart = 0, this.targetElement = null, this.touchStartX =
    0, this.touchStartY = 0, this.lastTouchIdentifier = 0, this.touchBoundary = b.touchBoundary || 10, this
    .layer = a, this.tapDelay = b.tapDelay || 200, !FastClick.notNeeded(a)) {
    for (var d = ["onMouse", "onClick", "onTouchStart", "onTouchMove", "onTouchEnd", "onTouchCancel"], e =
        this, f = 0, g = d.length; f < g; f++) e[d[f]] = function(a, b) {
      return function() {
        return a.apply(b, arguments)
      }
    }(e[d[f]], e);
    deviceIsAndroid && (a.addEventListener("mouseover", this.onMouse, !0), a.addEventListener("mousedown",
      this.onMouse, !0), a.addEventListener("mouseup", this.onMouse, !0)), a.addEventListener("click",
      this.onClick, !0), a.addEventListener("touchstart", this.onTouchStart, !1), a.addEventListener(
      "touchmove", this.onTouchMove, !1), a.addEventListener("touchend", this.onTouchEnd, !1), a.addEventListener(
      "touchcancel", this.onTouchCancel, !1), Event.prototype.stopImmediatePropagation || (a.removeEventListener =
      function(b, c, d) {
...
var App = function() {
    ...
    function b() {
      ...
      function b() {
        ...
        a.on("click", function() {
          l.hasClass(i.collapsibleSidebarCollapsedClass) ? (l.removeClass(i.collapsibleSidebarCollapsedClass),
            $("li.open", m).removeClass("open"), $("li.active", m).parents(".parent").addClass(
              "active open"), $(".be-scroller", m).perfectScrollbar("destroy")) : (l.addClass(i.collapsibleSidebarCollapsedClass),
            $("li.active", m).parents(".parent").removeClass("open"), $("li.open", m).removeClass(
              "open"))
        })
      }
      ...
      function c(a) {
        ...
        b = "undefined" != typeof a ? a : $(".sidebar-elements > li", m), $.each(b, function() {
          ...
          b.find("> li.title").length || (b.prepend(a), c.appendTo(d.find(".content ul")), d.appendTo(
            b))
        })
      }
      ...
      function g(b, c) {
        ...
        !$.isXs() && e() && (k || h) ? (f.removeClass("open"), b.removeClass("visible"), g.removeClass(
          "open").removeAttr("style")) : b.slideUp({
          duration: j,
          complete: function() {
            f.removeClass("open"), $(this).removeAttr("style"), g.removeClass("open").removeAttr(
              "style"), a()
          }
        })
      }
      ...
      function j() {
        i.toggleLeftSidebarButton.on("click", function(a) {
          o && k.hasClass(i.openLeftSidebarClass) ? (k.removeClass(i.openLeftSidebarClass), d()) : (k
            .addClass(i.openLeftSidebarClass + " " + i.transitionClass), o = !0), a.preventDefault()
        }), $(document).on("mousedown touchstart", function(a) {
          $(a.target).closest(m).length || $(a.target).closest(i.toggleLeftSidebarButton).length || !
            k.hasClass(i.openLeftSidebarClass) || (k.removeClass(i.openLeftSidebarClass), d())
        })
      }
      ...
      f() && (c(), b(), t || (n.on("mouseover", function(a) {
        ...
        var b = $(this),
          c = b.parent(),
          d = b.next();
        e() && !$.isXs() && (c.hasClass("open") ? g(d, a) : h(this, a), $(this).next().is("ul") &&
          a.preventDefault())
      ...
      }), l.hasClass(i.collapsibleSidebarCollapsedClass) ? $("li.active", m).parents(".parent").addClass(
        "active") : $("li.active", m).parents(".parent").addClass("active open"), l.hasClass(
        "be-fixed-sidebar") && ($.isXs() && !l.hasClass(i.offCanvasLeftSidebarClass) || r.perfectScrollbar(),
        $(window).resize(function() {
          p(function() {
            $.isXs() && !l.hasClass(i.offCanvasLeftSidebarClass) ? r.perfectScrollbar("destroy") :
              r.hasClass("ps-container") ? r.perfectScrollbar("update") : r.perfectScrollbar()
    ...
    function c() {
      ...
      n.length > 0 && ($(".be-toggle-right-sidebar").on("click", function(c) {
        ...
        !$(a.target).closest(n).length && k.hasClass(i.openRightSidebarClass) && (i.closeRsOnClickOutside ||
          $.isXs()) && b()
    ...
    function e() {
      l.swipe({
        ...
        swipeLeft: function(a) {
          !o && n.length > 0 && (k.addClass(i.openRightSidebarClass + " " + i.transitionClass), o = !
            0)
        },
    ...
    return {
      ...
      color: j,
      init: function(d) {
        $.extend(i, d), FastClick.attach(document.body), b(), c(), f(), i.enableSwipe && e(), i.scrollTop &&
          h(), j.primary = a("clr-primary"), j.success = a("clr-success"), j.warning = a("clr-warning"), j.danger =
          a("clr-danger"), j.grey = a("clr-grey"), $(".be-connections").on("click", function(a) {
            a.stopPropagation()
          }), g(), $(".dropdown").on("shown.bs.dropdown", function() {
            $(".be-scroller").perfectScrollbar("update")
          }), $(".nav-tabs").on("shown.bs.tab", function(a) {
            $(".be-scroller").perfectScrollbar("update")
          }), $('[data-toggle="tooltip"]').tooltip(), $('[data-toggle="popover"]').popover(), $(".modal").on(
            "show.bs.modal",
            function() {
...
FastClick.prototype.needsClick = function(a) {
  ...
  "use strict";
  var c, d, e, f;
  document.activeElement && document.activeElement !== a && document.activeElement.blur(), f = b.changedTouches[
      0], e = document.createEvent("MouseEvents"), e.initMouseEvent("mousedown", !0, !0, window, 1, f.screenX,
      f.screenY, f.clientX, f.clientY, !1, !1, !1, !1, 0, null), e.forwardedTouchEvent = !0, a.dispatchEvent(
      e), d = document.createEvent("MouseEvents"), d.initMouseEvent("mouseup", !0, !0, window, 1, f.screenX,
      f.screenY, f.clientX, f.clientY, !1, !1, !1, !1, 0, null), d.forwardedTouchEvent = !0, a.dispatchEvent(
      d), c = document.createEvent("MouseEvents"), c.initMouseEvent(this.determineEventType(a), !0, !0,
      window, 1, f.screenX, f.screenY, f.clientX, f.clientY, !1, !1, !1, !1, 0, null), c.forwardedTouchEvent = !
    0, a.dispatchEvent(c)
  ...
  return this.trackingClick = !0, this.trackingClickStart = a.timeStamp, this.targetElement = b, this.touchStartX =
    c.pageX, this.touchStartY = c.pageY, a.timeStamp - this.lastClickTime < this.tapDelay && a.preventDefault(), !
    0
  ...
  if (this.cancelNextClick = !1, this.lastClickTime = a.timeStamp, c = this.trackingClickStart, this.trackingClick = !
    1, this.trackingClickStart = 0, deviceIsIOSWithBadTarget && (f = a.changedTouches[0], g = document.elementFromPoint(
        f.pageX - window.pageXOffset, f.pageY - window.pageYOffset) || g, g.fastClickScrollParent = this.targetElement
      .fastClickScrollParent), "label" === (d = g.tagName.toLowerCase())) {
    if (b = this.findControl(g)) {
      if (this.focus(g), deviceIsAndroid) return !1;
      g = b
    }
  } else if (this.needsFocus(g)) return a.timeStamp - c > 100 || deviceIsIOS && window.top !== window &&
    "input" === d ? (this.targetElement = null, !1) : (this.focus(g), this.sendClick(g, a), deviceIsIOS &&
      "select" === d || (this.targetElement = null, a.preventDefault()), !1);
  return !(!deviceIsIOS || deviceIsIOS4 || !(e = g.fastClickScrollParent) || e.fastClickLastScrollTop === e
    .scrollTop) || (this.needsClick(g) || (a.preventDefault(), this.sendClick(g, a)), !1)
  ...
  return !(this.targetElement && !a.forwardedTouchEvent && a.cancelable && (!this.needsClick(this.targetElement) ||
    this.cancelNextClick) && (a.stopImmediatePropagation ? a.stopImmediatePropagation() : a.propagationStopped = !
  ...
  "use strict";
  var a = this.layer;
  deviceIsAndroid && (a.removeEventListener("mouseover", this.onMouse, !0), a.removeEventListener(
    "mousedown", this.onMouse, !0), a.removeEventListener("mouseup", this.onMouse, !0)), a.removeEventListener(
    "click", this.onClick, !0), a.removeEventListener("touchstart", this.onTouchStart, !1), a.removeEventListener(
    "touchmove", this.onTouchMove, !1), a.removeEventListener("touchend", this.onTouchEnd, !1), a.removeEventListener(
  ...
  if (deviceIsBlackBerry10 && (d = navigator.userAgent.match(/Version\/([0-9]*)\.([0-9]*)/), d[1] >= 10 &&
      d[2] >= 3 && (b = document.querySelector("meta[name=viewport]")))) {
    if (b.content.indexOf("user-scalable=no") !== -1) return !0;
  ...
  "use strict";
  return FastClick
}) : "undefined" != typeof module && module.exports ? (module.exports = FastClick.attach, module.exports.FastClick =
  FastClick) : window.FastClick = FastClick, ! function() {
  function a(c, d) {
    if (c = c ? c : "", d = d || {}, c instanceof a) return c;
    if (!(this instanceof a)) return new a(c, d);
    var e = b(c);
    this._originalInput = c, this._r = e.r, this._g = e.g, this._b = e.b, this._a = e.a, this._roundA = N(
        100 * this._a) / 100, this._format = d.format || e.format, this._gradientType = d.gradientType,
      this._r < 1 && (this._r = N(this._r)), this._g < 1 && (this._g = N(this._g)), this._b < 1 && (this._b =
        N(this._b)), this._ok = e.ok, this._tc_id = L++
  }
  ...
  function b(a) {
    var b = {
      ...
      f = !1,
      h = !1;
    return "string" == typeof a && (a = H(a)), "object" == typeof a && (a.hasOwnProperty("r") && a.hasOwnProperty(
        "g") && a.hasOwnProperty("b") ? (b = c(a.r, a.g, a.b), f = !0, h = "%" === String(a.r).substr(-
        1) ? "prgb" : "rgb") : a.hasOwnProperty("h") && a.hasOwnProperty("s") && a.hasOwnProperty("v") ?
      (a.s = E(a.s), a.v = E(a.v), b = g(a.h, a.s, a.v), f = !0, h = "hsv") : a.hasOwnProperty("h") &&
      a.hasOwnProperty("s") && a.hasOwnProperty("l") && (a.s = E(a.s), a.l = E(a.l), b = e(a.h, a.s, a.l),
        f = !0, h = "hsl"), a.hasOwnProperty("a") && (d = a.a)), d = x(d), {
      ok: f,
      format: a.format || h,
      r: O(255, P(b.r, 0)),
      g: O(255, P(b.g, 0)),
  ...
  function e(a, b, c) {
    function d(a, b, c) {
      return 0 > c && (c += 1), c > 1 && (c -= 1), 1 / 6 > c ? a + 6 * (b - a) * c : .5 > c ? b : 2 / 3 >
        c ? a + 6 * (b - a) * (2 / 3 - c) : a
    }
    var e, f, g;
  ...
  function h(a, b, c, d) {
    ...
    return d && e[0].charAt(0) == e[0].charAt(1) && e[1].charAt(0) == e[1].charAt(1) && e[2].charAt(0) ==
      e[2].charAt(1) ? e[0].charAt(0) + e[1].charAt(0) + e[2].charAt(0) : e.join("")
  }
  ...
  function n(b, c) {
    c = 0 === c ? 0 : c || 10;
    var d = a(b).toRgb();
    return d.r = P(0, O(255, d.r - N(255 * -(c / 100)))), d.g = P(0, O(255, d.g - N(255 * -(c / 100)))),
      d.b = P(0, O(255, d.b - N(255 * -(c / 100)))), a(d)
  }
  ...
  function y(a, b) {
    B(a) && (a = "100%");
    var c = C(a);
    return a = O(b, P(0, parseFloat(a))), c && (a = parseInt(a * b, 10) / 100), M.abs(a - b) < 1e-6 ? 1 :
      a % b / parseFloat(b)
  }
  ...
  a.prototype = {
    ...
    getLuminance: function() {
      ...
      return a = g.r / 255, b = g.g / 255, c = g.b / 255, d = .03928 >= a ? a / 12.92 : Math.pow((a + .055) /
          1.055, 2.4), e = .03928 >= b ? b / 12.92 : Math.pow((b + .055) / 1.055, 2.4), f = .03928 >= c ?
        c / 12.92 : Math.pow((c + .055) / 1.055, 2.4), .2126 * d + .7152 * e + .0722 * f
    },
    setAlpha: function(a) {
    ...
    toHslString: function() {
      var a = d(this._r, this._g, this._b),
        ...
        c = N(100 * a.s),
        e = N(100 * a.l);
      return 1 == this._a ? "hsl(" + b + ", " + c + "%, " + e + "%)" : "hsla(" + b + ", " + c + "%, " +
        e + "%, " + this._roundA + ")"
    },
    toHex: function(a) {
    ...
    toRgbString: function() {
      return 1 == this._a ? "rgb(" + N(this._r) + ", " + N(this._g) + ", " + N(this._b) + ")" : "rgba(" +
        N(this._r) + ", " + N(this._g) + ", " + N(this._b) + ", " + this._roundA + ")"
    },
    ...
    toPercentageRgbString: function() {
      return 1 == this._a ? "rgb(" + N(100 * y(this._r, 255)) + "%, " + N(100 * y(this._g, 255)) +
        "%, " + N(100 * y(this._b, 255)) + "%)" : "rgba(" + N(100 * y(this._r, 255)) + "%, " + N(100 *
          y(this._g, 255)) + "%, " + N(100 * y(this._b, 255)) + "%, " + this._roundA + ")"
    },
    toName: function() {
      return 0 === this._a ? "transparent" : !(this._a < 1) && (S[h(this._r, this._g, this._b, !0)] ||
        !1)
    },
    toFilter: function(b) {
      ...
      return "progid:DXImageTransform.Microsoft.gradient(" + e + "startColorstr=" + c + ",endColorstr=" +
        d + ")"
    },
    toString: function(a) {
      var b = !!a;
      ...
      return e ? "name" === a && 0 === this._a ? this.toName() : this.toRgbString() : ("rgb" === a && (
          c = this.toRgbString()), "prgb" === a && (c = this.toPercentageRgbString()), ("hex" === a ||
          "hex6" === a) && (c = this.toHexString()), "hex3" === a && (c = this.toHexString(!0)),
        "hex8" === a && (c = this.toHex8String()), "name" === a && (c = this.toName()), "hsl" === a &&
        (c = this.toHslString()), "hsv" === a && (c = this.toHsvString()), c || this.toHexString())
    },
    ...
    var d = a(b),
      e = a(c);
    return (Math.max(d.getLuminance(), e.getLuminance()) + .05) / (Math.min(d.getLuminance(), e.getLuminance()) +
      .05)
  ...
  "undefined" != typeof module && module.exports ? module.exports = a : "function" == typeof define &&
    define.amd ? define(function() {
      return a
    }) : window.tinycolor = a
}(), ! function(a) {
  "function" == typeof define && define.amd && define.amd.jQuery ? define(["jquery"], a) : a("undefined" !=
    typeof module && module.exports ? require("jquery") : jQuery)
}(function(a) {
  "use strict";

  function b(b) {
    return !b || void 0 !== b.allowPageScroll || void 0 === b.swipe && void 0 === b.swipeStatus || (b.allowPageScroll =
      k), void 0 !== b.click && void 0 === b.tap && (b.tap = b.click), b || (b = {}), b = a.extend({},
  ...
  function c(b, c) {
    function d(b) {
      if (!(ja() || a(b.target).closest(c.excludedElements, Ta).length > 0)) {
        ...
        if (!d.pointerType || "mouse" != d.pointerType || 0 != c.fallbackToMouseEvents) {
          var e, f = d.touches,
            g = f ? f[0] : d;
          return Ua = v, f ? Va = f.length : c.preventDefaultEvents !== !1 && b.preventDefault(), Ja =
            0, Ka = null, La = null, Ra = null, Ma = 0, Na = 0, Oa = 0, Pa = 1, Qa = 0, Sa = qa(), ha(),
            la(0, g), !f || Va === c.fingers || c.fingers === t || R() ? (Xa = za(), 2 == Va && (la(1,
              f[1]), Na = Oa = ta(Wa[0].start, Wa[1].start)), (c.swipeStatus || c.pinchStatus) && (
              e = J(d, Ua))) : e = !1, e === !1 ? (Ua = y, J(d, Ua), e) : (c.hold && (bb = setTimeout(
              a.proxy(function() {
    ...
    function D(a) {
      ...
      if (Ua !== x && Ua !== y && !ia()) {
        var d, e = b.touches,
          f = e ? e[0] : b,
          g = ma(f);
        if (Ya = za(), e && (Va = e.length), c.hold && clearTimeout(bb), Ua = w, 2 == Va && (0 == Na ?
            (la(1, e[1]), Na = Oa = ta(Wa[0].start, Wa[1].start)) : (ma(e[1]), Oa = ta(Wa[0].end, Wa[
              1].end), Ra = va(Wa[0].end, Wa[1].end)), Pa = ua(Na, Oa), Qa = Math.abs(Na - Oa)), Va ===
          c.fingers || c.fingers === t || !e || R()) {
          if (Ka = ya(g.start, g.end), La = ya(g.last, g.end), P(a, La), Ja = wa(g.start, g.end), Ma =
            sa(), oa(Ka, Ja), d = J(b, Ua), !c.triggerOnTouchEnd || c.triggerOnTouchLeave) {
            var h = !0;
            if (c.triggerOnTouchLeave) {
              var i = Aa(this);
              h = Ba(g.end, i)
            }!c.triggerOnTouchEnd && h ? Ua = I(w) : c.triggerOnTouchLeave && !h && (Ua = I(x)), Ua !=
              y && Ua != x || J(b, Ua)
          }
        } else Ua = y, J(b, Ua);
        d === !1 && (Ua = y, J(b, Ua))
    ...
    function E(a) {
      ...
      return ia() && (Va = $a), Ya = za(), Ma = sa(), M() || !L() ? (Ua = y, J(b, Ua)) : c.triggerOnTouchEnd ||
        c.triggerOnTouchEnd === !1 && Ua === w ? (c.preventDefaultEvents !== !1 && a.preventDefault(),
          Ua = x, J(b, Ua)) : !c.triggerOnTouchEnd && Y() ? (Ua = x, K(b, Ua, o)) : Ua === w && (Ua =
          y, J(b, Ua)), ka(!1), null
    }
    ...
    function H() {
      Ta.unbind(Ea, d), Ta.unbind(Ia, F), Ta.unbind(Fa, D), Ta.unbind(Ga, E), Ha && Ta.unbind(Ha, G),
        ka(!1)
    }
    ...
    function I(a) {
      var b = a,
        ...
        e = L(),
        f = M();
      return !d || f ? b = y : !e || a != w || c.triggerOnTouchEnd && !c.triggerOnTouchLeave ? !e &&
        a == x && c.triggerOnTouchLeave && (b = y) : b = x, b
    }

    function J(a, b) {
      var c, d = a.touches;
      return (V() || U()) && (c = K(a, b, m)), (S() || R()) && c !== !1 && (c = K(a, b, n)), ea() &&
        c !== !1 ? c = K(a, b, p) : fa() && c !== !1 ? c = K(a, b, q) : da() && c !== !1 && (c = K(a,
          b, o)), b === y && F(a), b === x && (d ? d.length || F(a) : F(a)), c
    }

    function K(b, d, k) {
      var l;
      if (k == m) {
        if (Ta.trigger("swipeStatus", [d, Ka || null, Ja || 0, Ma || 0, Va, Wa, La]), c.swipeStatus &&
          (l = c.swipeStatus.call(Ta, b, d, Ka || null, Ja || 0, Ma || 0, Va, Wa, La), l === !1))
          return !1;
        if (d == x && T()) {
          if (clearTimeout(ab), clearTimeout(bb), Ta.trigger("swipe", [Ka, Ja, Ma, Va, Wa, La]), c.swipe &&
            (l = c.swipe.call(Ta, b, Ka, Ja, Ma, Va, Wa, La), l === !1)) return !1;
          switch (Ka) {
            case e:
              Ta.trigger("swipeLeft", [Ka, Ja, Ma, Va, Wa, La]), c.swipeLeft && (l = c.swipeLeft.call(
                Ta, b, Ka, Ja, Ma, Va, Wa, La));
              break;
            case f:
              Ta.trigger("swipeRight", [Ka, Ja, Ma, Va, Wa, La]), c.swipeRight && (l = c.swipeRight.call(
                Ta, b, Ka, Ja, Ma, Va, Wa, La));
              break;
            case g:
              Ta.trigger("swipeUp", [Ka, Ja, Ma, Va, Wa, La]), c.swipeUp && (l = c.swipeUp.call(Ta, b,
                Ka, Ja, Ma, Va, Wa, La));
              break;
            case h:
              Ta.trigger("swipeDown", [Ka, Ja, Ma, Va, Wa, La]), c.swipeDown && (l = c.swipeDown.call(
                Ta, b, Ka, Ja, Ma, Va, Wa, La))
          }
        }
      }
      if (k == n) {
        if (Ta.trigger("pinchStatus", [d, Ra || null, Qa || 0, Ma || 0, Va, Pa, Wa]), c.pinchStatus &&
          (l = c.pinchStatus.call(Ta, b, d, Ra || null, Qa || 0, Ma || 0, Va, Pa, Wa), l === !1))
          return !1;
        if (d == x && Q()) switch (Ra) {
          case i:
            Ta.trigger("pinchIn", [Ra || null, Qa || 0, Ma || 0, Va, Pa, Wa]), c.pinchIn && (l = c.pinchIn
              .call(Ta, b, Ra || null, Qa || 0, Ma || 0, Va, Pa, Wa));
            break;
          case j:
            Ta.trigger("pinchOut", [Ra || null, Qa || 0, Ma || 0, Va, Pa, Wa]), c.pinchOut && (l =
              c.pinchOut.call(Ta, b, Ra || null, Qa || 0, Ma || 0, Va, Pa, Wa))
        }
      }
      return k == o ? d !== y && d !== x || (clearTimeout(ab), clearTimeout(bb), Z() && !aa() ? (_a =
        za(), ab = setTimeout(a.proxy(function() {
        ...
        c.tap.call(Ta, b, b.target)))) : k == p ? d !== y && d !== x || (clearTimeout(ab),
        clearTimeout(bb), _a = null, Ta.trigger("doubletap", [b.target]), c.doubleTap && (l = c.doubleTap
          .call(Ta, b, b.target))) : k == q && (d !== y && d !== x || (clearTimeout(ab), _a = null,
        Ta.trigger("longtap", [b.target]), c.longTap && (l = c.longTap.call(Ta, b, b.target)))), l
    }
    ...
    function ka(a) {
      Ta && (a === !0 ? (Ta.bind(Fa, D), Ta.bind(Ga, E), Ha && Ta.bind(Ha, G)) : (Ta.unbind(Fa, D, !1),
        Ta.unbind(Ga, E, !1), Ha && Ta.unbind(Ha, G, !1)), Ta.data(C + "_intouch", a === !0))
    }
    ...
    function la(a, b) {
      ...
      return c.start.x = c.last.x = c.end.x = b.pageX || b.clientX, c.start.y = c.last.y = c.end.y =
        b.pageY || b.clientY, Wa[a] = c, c
    }

    function ma(a) {
      var b = void 0 !== a.identifier ? a.identifier : 0,
        c = na(b);
      return null === c && (c = la(b, a)), c.last.x = c.end.x, c.last.y = c.end.y, c.end.x = a.pageX ||
        a.clientX, c.end.y = a.pageY || a.clientY, c
    }
    ...
    function ya(a, b) {
      if (Ca(a, b)) return k;
      var c = xa(a, b);
      return 45 >= c && c >= 0 ? e : 360 >= c && c >= 315 ? e : c >= 135 && 225 >= c ? f : c > 45 &&
        135 > c ? h : g
    }
...
var App = function() {
  ...
  App = function() {
    ...
    return App.chartsSparklines = function() {
      ...
      var e = tinycolor(App.color.primary),
        ...
        c = g.toString(),
        d = h.toString();
      $.fn.sparkline.defaults.common.lineColor = a, $.fn.sparkline.defaults.common.fillColor = e.setAlpha(.3)
        .toString(), $.fn.sparkline.defaults.line.spotColor = a, $.fn.sparkline.defaults.line.minSpotColor =
        a, $.fn.sparkline.defaults.line.maxSpotColor = a, $.fn.sparkline.defaults.line.highlightSpotColor =
        a, $.fn.sparkline.defaults.line.highlightLineColor = a, $.fn.sparkline.defaults.bar.barColor = a, $
        .fn.sparkline.defaults.bar.negBarColor = b, $.fn.sparkline.defaults.bar.stackedBarColor[0] = a, $.fn
        .sparkline.defaults.bar.stackedBarColor[1] = b, $.fn.sparkline.defaults.tristate.posBarColor = a, $
        .fn.sparkline.defaults.tristate.negBarColor = b, $.fn.sparkline.defaults.discrete.thresholdColor =
        b, $.fn.sparkline.defaults.bullet.targetColor = a, $.fn.sparkline.defaults.bullet.performanceColor =
        b, $.fn.sparkline.defaults.bullet.rangeColors[0] = f.setAlpha(.2).toString(), $.fn.sparkline.defaults
        .bullet.rangeColors[1] = f.setAlpha(.5).toString(), $.fn.sparkline.defaults.bullet.rangeColors[2] =
        f.setAlpha(.45).toString(), $.fn.sparkline.defaults.pie.sliceColors[0] = a, $.fn.sparkline.defaults
        .pie.sliceColors[1] = b, $.fn.sparkline.defaults.pie.sliceColors[2] = c, $.fn.sparkline.defaults.box
        .medianColor = a, $.fn.sparkline.defaults.box.boxFillColor = f.setAlpha(.5).toString(), $.fn.sparkline
        .defaults.box.boxLineColor = a, $.fn.sparkline.defaults.box.whiskerColor = d, $(".compositebar").sparkline(
          "html", {
            type: "bar",
            barColor: b
            ...
            pie: {
              ...
              label: {
                ...
                formatter: function(a, b) {
                  return '<div style="font-size:12px;text-align:center;padding:2px;color:#333;">' +
                    a + "</div>"
                }
              },
              highlight: {
      ...
      function a() {
        $('[data-toggle="counter"]').each(function(a, b) {
          var c = $(this),
            ...
            h = 0,
            i = 2.5;
          c.data("prefix") && (d = c.data("prefix")), c.data("suffix") && (e = c.data("suffix")), c.data(
            "start") && (f = c.data("start")), c.data("end") && (g = c.data("end")), c.data(
            "decimals") && (h = c.data("decimals")), c.data("duration") && (i = c.data("duration"));
        ...
        $.extend($.datepicker, {
          ...
          beforeShowDay: function(a) {
            var b = a.getMonth(),
              c = a.getDate(),
              d = a.getFullYear();
            return $.inArray(d + "-" + (b + 1) + "-" + c, f) != -1 ? [!0, "has-events",
              "This day has events!"
            ] : [!0, "", ""]
          },
    ...
    return App.formElements = function() {
      ...
      $(".reportrange").daterangepicker({
        ...
        a.on("change", function(a) {
          var d = "";
          this.files && this.files.length > 1 ? d = (this.getAttribute("data-multiple-caption") ||
            "").replace("{count}", this.files.length) : a.target.value && (d = a.target.value.split(
            "\\").pop()), d ? b.find("span").html(d) : b.html(c)
        })
      })
    }, App
  }(App || {}),
  App = function() {
    ...
    return App.masks = function() {
      $("[data-mask='date']").mask("99/99/9999"), $("[data-mask='phone']").mask("(999) 999-9999"), $(
        "[data-mask='phone-ext']").mask("(999) 999-9999? x99999"), $("[data-mask='phone-int']").mask(
        "+33 999 999 999"), $("[data-mask='taxid']").mask("99-9999999"), $("[data-mask='ssn']").mask(
        "999-99-9999"), $("[data-mask='product-key']").mask("a*-999-a999"), $("[data-mask='percent']").mask(
        "99%"), $("[data-mask='currency']").mask("$999,999,999.99")
    }, App
  }(App || {}),
  App = function() {
    "use strict";
    return App.formMultiselect = function() {
      ...
      for (var a = 1; a <= 100; a++) $("#example11").append('<option value="' + a + '">Options ' + a +
        "</option>");
